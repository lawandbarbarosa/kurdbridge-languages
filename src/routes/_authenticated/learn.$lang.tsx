...
function LessonNode({ lesson, dialect, disabled }: {
  lesson: { id: string; title_sorani: string; title_badini: string; title_en: string | null; summary_sorani: string | null; summary_badini: string | null; summary_en: string | null; passed: boolean; unlocked: boolean; score: number };
