  ...
  return (
    <div dir={dir} className="min-h-screen">
      ...
      <header className="border-b border-border/60 backdrop-blur-sm bg-background/70 sticky top-0 z-40">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 h-auto min-h-16 py-2 flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-14 sm:pt-20 pb-16 text-center">
