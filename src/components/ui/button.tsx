  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl squircle text-sm font-semibold cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        ...
        sm: "h-9 rounded-lg squircle px-3 text-xs",
        lg: "h-12 rounded-2xl squircle px-8 text-base",
        icon: "h-10 w-10 rounded-2xl squircle",
      },
    },
    defaultVariants: {
      variant: "default",
